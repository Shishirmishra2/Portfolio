          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <input 
                ...
                className="bg-transparent border-b border-border py-2 text-ink text-[0.95rem] focus:outline-none focus:border-accent transition-colors"
            ...
            <textarea 
              ...
              className="bg-transparent border-b border-border py-2 text-ink text-[0.95rem] focus:outline-none focus:border-accent transition-colors resize-none"
              disabled={status === 'loading'}
            ></textarea>
